...
C'est le fichier **circadian_rythm.txt** qui va être utilisé. C'est le plus petit Gene Set des GO SLIM, sans doute un des plus précis.  
...
files=c("circadian_rythm.txt")

name=c("Circadian rythm")

#Chargement Gene set 
data=read.table("circadian_rythm.txt",header=TRUE,sep='\t',check.names = FALSE)
