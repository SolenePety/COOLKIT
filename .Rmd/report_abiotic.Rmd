---
title: "ACP focus stress abiotic"
author: "Solène Pety"
date: "25/03/2021"
output:
  html_document:
...
```{r figure,fig.width=12}
grid=plot_grid(ACP_biotic.txt + theme(legend.position="none"),
               ACP_abiotic.txt + theme(legend.position="none"),
               ACP_photo.txt + theme(legend.position="none"),
               ACP_random.txt + theme(legend.position="none"),ncol=2)

legend <- get_legend(ACP_biotic.txt + theme(legend.box.margin = margin(0, 0, 0, 12)))

plot_grid(grid,legend,rel_widths = c(4, 1))
```
