...
```{r data,cache=TRUE}
setwd("C:/Users/spety/OneDrive/Documents/M1_BIMS/Stage/Rstudio/docs_txt")

#-----------------------------------------------------------------------------------#
                                    #Aracyc
#-----------------------------------------------------------------------------------#

data=read.table("ara_pathways.20210325.txt",sep="\t",header=TRUE,fill=TRUE)
...
data2=read.table("table_data.txt",sep="\t",header=TRUE)
Stress=data2[,2]
SampleID=data2[,3]
data2=data2[,c(-1,-2,-3)]
data2=t(data2)
...
#-----------------------------------------------------------------------------------#
                                    #GO SLIM
#-----------------------------------------------------------------------------------#
files=c("circadian_rythm.txt","photo.txt",
        "abiotic.txt","biotic.txt","endogenous.txt",
        "external.txt","flower.txt","growth.txt",
        "light.txt")
name=c("Rythm circadian","Photosynthesis","Abiotic",
       "Biotic","Endogenous","External","Flower","Growth","Light")

Liste=list()
for(f in 1:length(files)){
  data3=read.table(files[f],sep="\t",header=TRUE)
  data3=data3[,c(-1,-2,-3)]
  col=colnames(data3)
  Liste[f]=list(col)
}
...
#save(plierResult,file="plierResult")
load("plierResult")
```
...
#-----------------------------------------------------------------------------------#
design=read.table("GEO_photo.txt",fill=TRUE,header=TRUE,sep="\t")
...
setwd("C:/Users/spety/OneDrive/Documents/M1_BIMS/Stage/figures")
#-----------------------------------------------------------------------------#
